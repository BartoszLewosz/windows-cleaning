...
class ContactForm(forms.Form):
    ...
    phone = forms.CharField(max_length=15, label='PHONE', error_messages={'required': 'Please enter your phone number'})
    subject = forms.CharField(required=False, max_length=100, label='SUBJECT')
    message = forms.CharField(widget=forms.Textarea, label='MESSAGE', error_messages={'required': 'Please enter your some details'})